...
BigOldBoobs1999 <- aov(val ~ highest_alcohol_type, data = AlcyWalky1999)
summary(BigOldBoobs1999)
TukeyHSD(BigOldBoobs1999)
...
BigOldBoobs2009 <- aov(val ~ highest_alcohol_type, data = AlcyWalky2009)
summary(BigOldBoobs2009)
TukeyHSD(BigOldBoobs2009)
...
BigOldBoobs2019 <- aov(val ~ highest_alcohol_type, data = AlcyWalky2019)
summary(BigOldBoobs2019)
TukeyHSD(BigOldBoobs2019)
