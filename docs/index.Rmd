...
In only 2019, the NIH reported that alcohol-related deaths accounted for 2.07 million male deaths and 374 thousand female deaths globally [a].

In 2020 (the first year of the COVID pandemic) alcohol sales increased by 2.9%, which is the largest annual increase in the last 50 years [b]. Although this presentation does not include COVID era data, it still gives reliable indicators as to AUD trends. 

2019 studies from the CDC estimate 3/10 people who regularly use cannabis have CUD [c]. 
...
Below are the residuals for the AUD 2019 deaths model. In the Kolmogorov-Smirnov test with 95% confidence, we find a test statistic of 0.2395 and p-value 0.0000, therefore rejecting the null hypothesis and concluding that the residuals are not normal.
...
The Q-Q Plot displays much more normal residuals, and the Cook's Distance still reveals several high-leverage points, but there are no influential points. 
...
[8] GDP per capita (current US$). World Bank Open Data. (n.d.-a). https://data.worldbank.org/indicator/NY.GDP.PCAP.CD
...
[15] World Health Organization. (n.d.-a). Gho | by category | age limits - alcohol service/sales - by country. World Health Organization. https://apps.who.int/gho/data/node.main.A1144?lang=en 
